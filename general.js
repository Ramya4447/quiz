...
if(index<arraylength){
    ...
    document.getElementById("answerbox1").disabled=false;
    document.getElementById("answerbox2").disabled=false;
    document.getElementById("answerbox3").disabled=false;
    document.getElementById("answerbox4").disabled=false;
    timing();
}
else{
    localStorage.setItem("scoree",score);
